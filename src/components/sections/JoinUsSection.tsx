        ...
        <ol className="relative mx-auto mt-12 max-w-3xl list-none border-l border-navy-100 pl-10">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex flex-col rounded-3xl bg-white/90 p-6 text-left shadow-card transition-all duration-300 group-hover:shadow-card-hover sm:px-8 sm:py-7">
                ...
                {step.email && (
                  <div className="mt-4 inline-flex max-w-full flex-wrap items-center gap-2 rounded-2xl bg-primary/5 px-4 py-3 text-sm text-primary">
